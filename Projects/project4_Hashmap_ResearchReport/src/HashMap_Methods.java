...
public class HashMap_Methods {
    ...
    private String ans2;
    //******************************************************************
    //The key is the desk, which is incramented by one for each student added
    //This is the list of students used for the put method the values associated with the desk
    int desk = 0;
